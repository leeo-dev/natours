...
const userSchema = new mongoose.Schema({
  ...
  email: {type: String, required: [true, 'Please provide your E-mail!'], unique: true, lowercase: true, validate: [validator.isEmail, 'Please provide a valid E-mail']},
  photo: {type: String},
